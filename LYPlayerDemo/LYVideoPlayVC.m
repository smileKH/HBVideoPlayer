...
- (void)viewDidLoad {
    ...
    //@"http://cdn.tumbo.com.cn/follomeFront//file/library/library_moment_video/2016/11/02/20161102171719373752095.mp4"
    ...
    NSString *url = [self.videoUrl stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    
    self.videoPlayer = [[LYVideoPlayer alloc] init];
    self.videoPlayer.delegate = self;
    [self.videoPlayer playWithUrl:url showView:self.videoPlayBGView];
